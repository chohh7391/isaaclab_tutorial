...
import isaaclab_tutorial.tasks.manager_based.locomotion.velocity.mdp as mdp
from isaaclab_tutorial.tasks.manager_based.locomotion.velocity.velocity_env_cfg import (
    ActionsCfg,
...
# Pre-defined configs
##
from isaaclab_tutorial.assets.terrains import DRIVABLE_TERRAINS_CFG
from isaaclab_tutorial.assets.robot import WHEEL_LEG_HUMANOID_CFG
...
@configclass
class WheelLegHumanoidDrivingRoughEnvCfg_PLAY(WheelLegHumanoidDrivingRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        if self.__class__.__name__ == "WheelLegHumanoidDrivingRoughEnvCfg_PLAY":
            self.disable_zero_weight_rewards()