...
from isaaclab_tutorial.assets.robot.wheel_leg_humanoid import WHEEL_LEG_HUMANOID_CFG
##
# Pre-defined configs
##
...
@configclass
class WheelLegHumanoidWalkingRoughEnvCfg_PLAY(WheelLegHumanoidWalkingRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        if self.__class__.__name__ == "WheelLegHumanoidWalkingRoughEnvCfg_PLAY":
            self.disable_zero_weight_rewards()
