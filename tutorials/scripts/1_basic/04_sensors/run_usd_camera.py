...
.. code-block:: bash
    ...
    # Usage with GUI
    python tutorials/scripts/1_basic/04_sensors/run_usd_camera.py --enable_cameras

    # Usage with headless
    python tutorials/scripts/1_basic/04_sensors/run_usd_camera.py --headless --enable_cameras
